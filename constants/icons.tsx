...
export const GroupIcon: React.FC<{className?: string}> = ({className}) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.962a3.75 3.75 0 100-7.5 3.75 3.75 0 000 7.5zM10.5 18.75a9 9 0 00-9-9v3.75m1.5-3.75a9 9 0 0118 0v3.75m-1.5-3.75a9 9 0 00-9-9" />
  </svg>
);
...
export const PaletteIcon: React.FC<{className?: string}> = ({className}) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 7.5l2.121-2.121a3.75 3.75 0 00-5.304-5.304L12 1.575M18.75 10.5l-1.414-1.414" />
    </svg>
);
...
export const MuteIcon: React.FC<{className?: string}> = ({className}) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M17.25 9.75L19.5 12m0 0l2.25 2.25M19.5 12l2.25-2.25M19.5 12l-2.25 2.25m-10.5-6l4.72-4.72a.75.75 0 011.28.531V19.94a.75.75 0 01-1.28.53l-4.72-4.72M4.5 12H9v-2.25H4.5V12z" />
    </svg>
);
...
const DoubleCheckIcon: React.FC<{className?: string}> = ({className}) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M11.35 4.536l-1.047.926A4.5 4.5 0 004.5 9.75l6.5 6.5a4.5 4.5 0 006.364-6.364l-1.047-.926" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 7.5l-6.5 6.5" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 12l6-6" />
    </svg>
);

export const MicrophoneIcon: React.FC<{className?: string}> = ({className}) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path d="M12 18.75a6 6 0 006-6v-1.5a6 6 0 00-12 0v1.5a6 6 0 006 6zM10.5 5.25a.75.75 0 00-1.5 0v.161a8.93 8.93 0 00-1.66.422.75.75 0 00-.67 1.223 7.479 7.479 0 014.66 0 .75.75 0 00-.67-1.223A8.93 8.93 0 0012 5.411V5.25a.75.75 0 00-1.5 0z" />
        <path fillRule="evenodd" d="M12 21a8.25 8.25 0 008.25-8.25V12a8.25 8.25 0 00-16.5 0v.75A8.25 8.25 0 0012 21zm-2.25-5.25a.75.75 0 000 1.5h4.5a.75.75 0 000-1.5h-4.5z" clipRule="evenodd" />
    </svg>
);
